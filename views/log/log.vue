...
const columns = [
  { title: '序号', dataIndex: 'num', key: 'num',width: '70px' },
  ...
  { title: '操作时间', dataIndex: 'datetime', key: 'datetime' ,scopedSlots: { customRender: 'datetime' },
    width: '200px'},
  { title: '日志来源', dataIndex: 'ipaddress', key: 'ipaddress' ,scopedSlots: { customRender: 'ipaddress' } ,width: '150px'},
